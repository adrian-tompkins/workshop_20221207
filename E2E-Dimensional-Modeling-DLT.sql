...
AS SELECT *, input_file_name() as input_file_name FROM cloud_files("dbfs:/example_kimball_source/date*", "csv", map("cloudFiles.inferColumnTypes", "true"));
...
AS SELECT *, input_file_name() as input_file_name FROM cloud_files("dbfs:/example_kimball_source/customer*", "csv", map("cloudFiles.inferColumnTypes", "true"));
...
AS SELECT *, input_file_name() as input_file_name FROM cloud_files("dbfs:/example_kimball_source/product*", "csv", map("cloudFiles.inferColumnTypes", "true"));
...
AS SELECT *, input_file_name() as input_file_name FROM cloud_files("dbfs:/example_kimball_source/store*", "csv", map("cloudFiles.inferColumnTypes", "true"));
...
AS SELECT *, input_file_name() as input_file_name FROM cloud_files("dbfs:/example_kimball_source/sale*", "csv", map("cloudFiles.inferColumnTypes", "true"));
