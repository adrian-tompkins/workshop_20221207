...
-- MAGIC We can create a secure view for this data and only grant our analyst access to this view: 
...
-- MAGIC 
-- MAGIC The country example was a first level of row-level security implementation. We can implement more advanced features using the same pattern.
-- MAGIC 
